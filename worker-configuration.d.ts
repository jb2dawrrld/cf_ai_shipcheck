/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b485fe4b4c616e06374c64d2b4e47a58)
...
declare namespace Cloudflare {
	...
	interface Env {
		AI: Ai;
		REVIEW_AGENT: DurableObjectNamespace<import("./src/index").ReviewAgent>;
		DEPLOYMENT_REVIEW_WORKFLOW: Workflow<Parameters<import("./src/index").DeploymentReviewWorkflow['run']>[0]['payload']>;
	}
}
